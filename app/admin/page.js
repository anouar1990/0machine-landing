...
export default function AdminDashboard() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setAuthError(err.message || "Google authentication failed. Please use email & password below.");
            ...
            {!session ? (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-white text-gray-900 font-semibold text-sm py-2.5 px-4 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors shadow-lg disabled:opacity-60"
                >
                  {googleLoading ? (
                    <>
                      <RefreshCw className="animate-spin text-gray-900" size={18} />
                ...
                <div className="relative my-4 flex items-center justify-center">
                  ...
                  <span className="bg-dark-950 px-3 text-[10px] uppercase font-semibold text-gray-500 shrink-0">or password</span>
                  <div className="border-t border-white/10 w-full"></div>
                </div>
