            ...
            {!session ? (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-white text-gray-900 font-semibold text-sm py-2.5 px-4 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors shadow-lg"
                >
