...
const steps = [
  {
    ...
    desc: "Add your project with materials, photos, and client details. Use templates to start recurring jobs in seconds.",
    icon: (
  ...
  },
  {
    ...
    desc: "Use the Cost Calculator to get your true cost — material, machine time, labor, electricity. Generate a professional quote instantly.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    num: "03",
    title: "Produce & Track",
    desc: "Load your Laser Presets, start the built-in timer, and track progress. Move orders from Pending to In Progress automatically.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    num: "04",
    title: "Deliver & Grow",
    desc: "Export PDF reports for clients, review your analytics, and see which projects drive the most revenue. Grow with data, not guesswork.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-400 max-w-xl mx-auto text-lg">
            A streamlined workflow that mirrors how real laser workshops operate.
          </p>
        </motion.div>
