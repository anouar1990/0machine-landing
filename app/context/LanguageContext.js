...
export const translations = {
  en: {
    ...
    "nav.pricing": "Pricing",
    "nav.signin": "Sign In",
    "nav.trial": "Start Free",
    
    // Hero
    "hero.badge": "Built Exclusively for Laser & CNC Workshops",
    "hero.title1": "Run Your Laser",
    "hero.title2": "Business ",
    "hero.titleAccent": "Smarter.",
    "hero.subtitle": "Calculate exact job costs in seconds, track material inventory, quote clients with confidence, and access unlimited ready-to-cut vector templates. Free forever.",
    "hero.ctaTrial": "⚡ Start Free Forever",
    "hero.ctaFeatures": "See How It Works →",
    "hero.trialNote": "No credit card required · Free forever account · Upgrade to Pro anytime for $19/mo",
    ...
    "price.title": "Choose the Perfect Plan for",
    "price.titleAccent": "Your Laser Workshop",
    "price.subtitle": "Start free forever. Upgrade anytime as your workshop grows.",
    "price.popular": "⭐ Most Popular",
    
    "price.free.name": "Free Forever",
    "price.free.price": "$0",
    "price.free.period": "forever",
    "price.free.desc": "Perfect for hobbyists discovering 0Machine.",
    "price.free.f1": "3 Projects per Month",
    "price.free.f2": "1 Machine Profile",
    "price.free.f3": "Basic Job Cost Calculator",
    "price.free.f4": "PDF Quote Export",
    "price.free.f5": "Community Support",
    "price.free.cta": "Start Free",
    
    "price.starter.name": "Starter",
    "price.starter.price_mo": "$9",
    "price.starter.price_yr": "$59",
    "price.starter.desc": "Perfect for makers and small workshops.",
    "price.starter.f1": "Unlimited Projects & Machine Profiles",
    "price.starter.f2": "Material Inventory & Laser Presets",
    "price.starter.f3": "PDF Quotes & Invoices",
    "price.starter.f4": "Design Library Access",
    "price.starter.f5": "Basic Dashboard & Email Support",
    "price.starter.cta": "Upgrade to Starter",

    "price.pro.name": "Workshop Pro",
    "price.pro.price_mo": "$19",
    "price.pro.price_yr": "$149",
    "price.pro.desc": "Everything in Starter plus advanced optimization.",
    "price.pro.f1": "Everything in Starter +",
    "price.pro.f2": "Nesting Yield Calculator",
    "price.pro.f3": "1-Click WhatsApp Sharing",
    "price.pro.f4": "CSV & Excel Data Exports",
    "price.pro.f5": "Team Workspace (3 Users)",
    "price.pro.f6": "Commercial Vector Packs & Priority Support",
    "price.pro.cta": "Upgrade to Pro",
    "price.pro.f6": "Priority Workshop Support",
    "price.pro.cta": "Upgrade to Pro ($19/mo)",
    ...
    "final.cta.trial": "⚡ Start Free Forever",
    "final.cta.features": "Explore Features",
    "final.terms": "No credit card required · Free forever account · Upgrade to Pro anytime for $19/mo",
  ...
  fr: {
    ...
    "benefits.presets.title": "Chargez les réglages parfaits en 10 secondes",
    "benefits.presets.desc": "Enregistrez la vitesse, la puissance, la fréquence et les passes pour chaque matériau et machine. Ne gâchez plus jamais de matériaux avec de mauvais réglages.",
    "benefits.presets.outcome": "Des découpes parfaites du premier coup, à chaque fois",
    "benefits.presets.stat": "10s",
    "benefits.presets.statLabel": "pour régler votre laser",
    
    "benefits.quote.feature": "Générateur de Devis PDF",
    "benefits.quote.title": "Envoyez des devis professionnels en 60 secondes",
    "benefits.quote.desc": "Générez des devis et factures PDF professionnels avec vos prix, détails clients et conditions. Exportez et partagez directement par e-mail ou WhatsApp.",
    "benefits.quote.outcome": "Signez plus de contrats avec des devis professionnels",
    "benefits.quote.stat": "60s",
    "benefits.quote.statLabel": "pour envoyer un devis",
    
    // Mockup Showcase
    "mock.title": "Tout ce dont votre atelier a besoin",
    "mock.titleAccent": "dans une seule appli.",
    "mock.subtitle": "Basculez entre vos projets, votre inventaire et vos préréglages en un clic.",
    
    // Interactive Mockup Texts
    "mock.total": "Total",
    "mock.inprogress": "En cours",
    "mock.completed": "Terminé",
    "mock.revenue": "Revenus",
    "mock.recent": "PROJETS RÉCENTS",
    "mock.coasters": "Sous-verres personnalisés",
    "mock.birch": "Contreplaqué Bouleau 3mm",
    "mock.sheet": "Coût Feuille",
    ...
    "social.t6.text": "Le compte gratuit m'a convaincue. J'ai configuré 5 projets dès la première heure. Au deuxième jour, j'ai pris le Pass Pro pour débloquer les vecteurs. Vaut chaque dollar.",
    
    // Pricing
    "price.badge": "Tarifs Transparents",
    "price.title": "Commencez Gratuitement, Passez à",
    "price.titleAccent": "l'Atelier Pro",
    "price.subtitle": "Les outils de base sont gratuits pour toujours. Passez à Pro (19 $/mois) pour débloquer la bibliothèque de designs, l'imbrication et l'exportation de factures.",
    "price.popular": "Le Plus Populaire",
    
    "price.hobby.name": "Gratuit pour Toujours",
    "price.hobby.price": "0 $",
    "price.hobby.period": "pour toujours",
    "price.hobby.desc": "Outils d'atelier essentiels pour découpeurs laser et créateurs CNC.",
    "price.hobby.f1": "Projets de base illimités",
    "price.hobby.f2": "Calculateur de coût & marge en temps réel",
    "price.hobby.f3": "Inventaire des matériaux & alertes",
    "price.hobby.f4": "Profils de machines & préréglages",
    "price.hobby.f5": "Suivi des commandes & clients",
    "price.hobby.f6": "Générateur de devis instantané",
    "price.hobby.cta": "Commencer Gratuitement",
    
    "price.pro.name": "Atelier Pro",
    "price.pro.price": "19 $",
    "price.pro.period": "/mois",
    "price.pro.desc": "Débloque la bibliothèque de fichiers vectoriels, l'imbrication et l'exportation PDF.",
    "price.pro.f1": "Inclut TOUT ce qui est dans Gratuit",
    "price.pro.f2": "Bibliothèque de designs (modèles vectoriels illimités)",
    "price.pro.f3": "Outil d'imbrication (optimiseur de rendement)",
    "price.pro.f4": "Générateur de factures (exports PDF personnalisés)",
    "price.pro.f5": "Analyses avancées des revenus",
    "price.pro.f6": "Support prioritaire d'atelier",
    "price.pro.cta": "Passer à Pro (19 $/mois)",
    ...
    "final.cta.trial": "⚡ Commencer Gratuitement",
    "final.cta.features": "Explorer les Fonctionnalités",
    "final.terms": "Pas de carte requise · Compte gratuit pour toujours · Option Pro à 19 $/mois",
  ...
  es: {
    ...
    "hero.ctaTrial": "⚡ Empezar Gratis",
    "hero.ctaFeatures": "Características →",
    "hero.trialNote": "Cuenta gratis para siempre · Opción Pro por $19/mes · Sin tarjeta requerida",
    
    // Pricing
    "price.badge": "Precios Transparentes",
    "price.title": "Empiece Gratis, Actualice a",
    "price.titleAccent": "Taller Pro",
    "price.subtitle": "Las herramientas esenciales son gratis para siempre. Actualice a Pro ($19/mes) para desbloquear la biblioteca de diseños, optimizador de nesting y facturas PDF.",
    "price.popular": "Más Popular",
    
    "price.hobby.name": "Gratis para Siempre",
    "price.hobby.price": "$0",
    "price.hobby.period": "para siempre",
    "price.hobby.desc": "Herramientas de taller esenciales para creadores de láser y CNC.",
    "price.hobby.f1": "Proyectos básicos ilimitados",
    "price.hobby.f2": "Calculadora de costo y margen en tiempo real",
    "price.hobby.f3": "Inventario de materiales y alertas de stock",
    "price.hobby.f4": "Perfiles de máquinas y ajustes preestablecidos",
    "price.hobby.f5": "Rastreador de pedidos y registro de clientes",
    "price.hobby.f6": "Generador de presupuestos al instante",
    "price.hobby.cta": "Empezar Gratis para Siempre",
    
    "price.pro.name": "Taller Pro",
    "price.pro.price": "$19",
    "price.pro.period": "/mes",
    "price.pro.desc": "Desbloquea la biblioteca de vectores, optimizador de nesting y facturas PDF.",
    "price.pro.f1": "Incluye TODO lo de Gratis",
    "price.pro.f2": "Biblioteca de diseños (plantillas vectoriales ilimitadas)",
    "price.pro.f3": "Herramienta de nesting (optimizador de material)",
    "price.pro.f4": "Generador de facturas (exportación PDF personalizada)",
    "price.pro.f5": "Analíticas avanzadas de ingresos",
    "price.pro.f6": "Soporte prioritario de taller",
    "price.pro.cta": "Actualizar a Pro ($19/mes)",
    ...
    "final.cta.trial": "⚡ Empezar Gratis para Siempre",
    "final.cta.features": "Explorar Características",
    "final.terms": "Sin tarjeta requerida · Cuenta gratis para siempre · Opción Pro por $19/mes",
