...
export const translations = {
  en: {
    ...
    "hero.subtitle": "Calculate exact job costs in seconds, track material inventory, quote clients with confidence, and access 500+ ready-to-cut vector templates. Free forever.",
  ...
  fr: {
    ...
    "price.pro.f2": "Bibliothèque de designs (500+ modèles vectoriels)",
  ...
  es: {
    ...
    "price.pro.f2": "Biblioteca de diseños (500+ plantillas vectoriales)",
