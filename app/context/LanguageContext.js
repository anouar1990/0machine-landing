...
export const translations = {
  en: {
    ...
    "price.title": "Start Free, Upgrade to",
    "price.titleAccent": "Pro Power Tools",
    "price.subtitle": "Core workshop tools are free forever. Upgrade to Pro ($19/mo) anytime to unlock Design Library, Nesting, and Invoice Exports.",
    "price.popular": "Best Value for Growing Shops",
    
    "price.hobby.name": "Free Forever",
    "price.hobby.price": "$0",
    "price.hobby.period": "forever",
    "price.hobby.desc": "Essential workshop tools for laser cutters and makers.",
    "price.hobby.f1": "Unlimited core projects",
    "price.hobby.f2": "Real-time Cost & Profit Calculator",
    "price.hobby.f3": "Material Inventory & Stock Alerts",
    "price.hobby.f4": "Machine Profiles & Laser Presets",
    "price.hobby.f5": "Order Tracker & Client Ledger",
    "price.hobby.f6": "Instant Quote Generator",
    "price.hobby.cta": "Start Free Forever",
    
    "price.pro.name": "Pro Workshop",
    "price.pro.price": "$19",
    "price.pro.period": "/month",
    "price.pro.desc": "Unlocks high-value power tools and template downloads.",
    "price.pro.f1": "Includes EVERYTHING in Free",
    "price.pro.f2": "Design Library (500+ vector templates)",
    "price.pro.f3": "Nesting Tool (sheet yield optimizer)",
    "price.pro.f4": "Invoice Generator (custom PDF exports)",
    "price.pro.f5": "Advanced Revenue Analytics",
